...
def main(args):
    ...
    with open(os.path.join(args.log_path, folder_name, exec_summary_file_name), 'w') as txt_file_object:
        ...
        txt_file_object.write("\nD_iters: %d; G_iters: %d; latent_dim: %d; embedding_dim:%d"%(args.D_iters, args.G_iters, args.latent_dim, args.embedding_dim))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_device', default="2,3,4,5,6,7", help="GPU devices to be used")
    ...
    # path details
    parser.add_argument('--image_path', type=str, default='/research/iprobe-paldebas/Research Work/GAN (Phenology Images)/phenocamdata/')
    ...
    # model parameters 
    parser.add_argument('--model', type=str, default='DCGAN', choices=['DCGAN','standard_CNN'])
    parser.add_argument('--adv_loss', type=str, default='HingeGAN', choices=['SGAN', 'LSGAN', 'WGAN-GP', 'HingeGAN'])
    parser.add_argument('--version', type=str, default= 'v5_1_1')
    parser.add_argument('--spectral_G', default=False, help='Whetherto use spectral normalization in generator')
    parser.add_argument('--spectral_D', default=False, help='Whether to use spectral normalization in discriminator')
    ...
    parser.add_argument('--train_data_vol_per', type=float, default=1.0)
    parser.add_argument('--num_samples', type=int, default=20)
    parser.add_argument('--n_rows', type=int, default=4)
    parser.add_argument('--n_cols', type=int, default=5)
    parser.add_argument('--plot_figsize', default=(22,20)) 
